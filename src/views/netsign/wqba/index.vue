...
<script>
import { listWqba, getWqba, delWqba, addWqba, updateWqba } from "@/api/system/wqba";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/wqba/export', {
        ...this.queryParams
