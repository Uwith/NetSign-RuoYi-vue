    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:buyer:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:buyer:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listBuyer, getBuyer, delBuyer, addBuyer, updateBuyer } from "@/api/system/buyer";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/buyer/export', {
        ...this.queryParams
