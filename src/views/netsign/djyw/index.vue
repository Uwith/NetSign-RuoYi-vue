<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="djywList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文件内容" align="center" prop="wjnr" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="文件类型" prop="wjlx">
          <el-input v-model="form.wjlx" placeholder="请输入文件类型" />
        </el-form-item>
        <el-form-item label="文件内容" prop="wjnr">
          <el-input v-model="form.wjnr" type="textarea" placeholder="请输入内容" />
        </el-form-item>
...
<script>
import { listDjyw, getDjyw, delDjyw, addDjyw, updateDjyw } from "@/api/system/djyw";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/djyw/export', {
        ...this.queryParams
