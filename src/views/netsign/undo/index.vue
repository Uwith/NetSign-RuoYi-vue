    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['netsign:undo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['netsign:undo:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listUndo, getUndo, delUndo, addUndo, updateUndo } from "@/api/netsign/undo";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('netsign/undo/export', {
        ...this.queryParams
